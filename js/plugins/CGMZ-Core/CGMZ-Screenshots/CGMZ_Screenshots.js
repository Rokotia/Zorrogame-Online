 ...
 * rename the js file.
 * --------------------------Latest Version------------------------------------
 * Hi all, this latest version adds some additional input options. You can now
 * set an additional key in plugin params that will take a screenshot. This is
 * in case a player might have a keyboard with no Print Screen button.
 *
 * This update also added a gamepad screenshot button, so your players using
 * controllers can also take screenshots.
 *
 * Version 1.1.0
...
CGMZ.Versions["Screenshots"] = "1.1.0";
CGMZ.Screenshots = {};
